      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell colSpan={2} className="fixtures-table-header">
              Teams
            </TableCell>
            <TableCell align="center" className="fixtures-table-header">
              Score
            </TableCell>
            <TableCell align="center" className="fixtures-table-header">
              Status
            ...
            <TableRow key={idx} hover>
              <TableCell>
                <Box className="fixtures-time-box">
                  <AccessTimeIcon
                    fontSize="small"
                    className="fixtures-time-icon"
                  />
                  {row.time}
                </Box>
              </TableCell>
              <TableCell align="right" className="fixtures-team-cell">
                <span className="fixtures-flag">{row.teams[0].flag}</span>{" "}
                {row.teams[0].name}
              </TableCell>
              <TableCell align="left" className="fixtures-team-cell">
                <span className="fixtures-flag">{row.teams[1].flag}</span>{" "}
                {row.teams[1].name}
              </TableCell>
              <TableCell align="center" className="fixtures-score-cell">
                {row.score[0]} <span className="fixtures-score-dash">-</span>{" "}
                {row.score[1]}
              </TableCell>
              <TableCell align="center">
                ...
                {row.countdown && (
                  <Chip
                    ...
                    color="success"
                    size="small"
                    className="fixtures-countdown-chip"
                  />
                )}
              </TableCell>
              ...
              <TableCell>
                <Typography variant="body2" className="fixtures-event-title">
                  {row.event}
                </Typography>
