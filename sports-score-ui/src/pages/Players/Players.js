...
const Players = () => (
  <Container maxWidth="lg" className="players-container">
    <Typography variant="h4" gutterBottom className="players-title">All Valorant Players</Typography>
          ...
          <Card className="player-card">
            <Box className="player-card-box">
              ...
              <Box className="player-nick-rank">
                <Typography variant="h6" fontWeight={700} className="player-nickname">{player.nickname}</Typography>
                <img
              ...
              <Typography variant="body2" color="grey.400" className="player-realname">{player.realName}</Typography>
              <Typography variant="body2" fontWeight={600} className="player-team">{player.team}</Typography>
            </Box>
          </Card>
        </Grid>
      ))}
